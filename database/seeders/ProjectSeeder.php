...
class ProjectSeeder extends Seeder
{
    ...
    public function run(): void
    {
        Project::create([
            ...
            'image_path'=> 'project_images\discord.png',
        ]);
        Project::create([
            'name' => 'js-our-team',
        ...
        Project::create([
            ...
            'image_path'=> 'project_images\php.png',
        ]);
    }
}
